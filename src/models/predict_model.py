...
print(time.strftime("%H:%M:%S") + '> start merge trained data...')
...
print(time.strftime("%H:%M:%S") + '> apply weights to merged trained data...')
...
print(time.strftime("%H:%M:%S") + '> start LinearRegression...')
...
print(time.strftime("%H:%M:%S") + '> finish predict LinearRegression...')
...
print(time.strftime("%H:%M:%S") + '> start prep submission data...')
...
print(time.strftime("%H:%M:%S") + '> finish submission data.')
